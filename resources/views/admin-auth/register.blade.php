...
<div class="login-admin">
    <div class="row">
        <div class="col-lg-8 col-md-8 contenu-left">
            <div class="img">
                <img src="{{ asset('images/qrcode.png') }}" width="100%" height="100%">
            </div>
        </div>
        <div class="col-lg-4 col-md-4 contenu-right">
            <form method="POST" action="{{ route('admin.register') }}" aria-label="{{ __('Register') }}">
                        @csrf
  ...
  <div class="form-group">
    ...
    <input placeholder="Enter Password" id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
  </div>
  <button type="submit" class="btn btn-primary">Register</button>
  <div class="link-lo-re"><a href="/admin/login">Login</a></div>
</form>
        </div>
    </div>
</div>
